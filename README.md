...
iARTS refuses everything until only what holds true remains.
...
Each agent has a single role. Some expand. Some destroy. One never agrees. One refuses to integrate noise. One distills what survives into a single structured decision.

The loop does not end until the idea has been forced open, attacked, synthesized, disrupted, reintegrated, and distilled.
